 ...
 * @author ultabook
 */
public class adminIndividualUserPrinting extends javax.swing.JFrame {

    /**
     * Creates new form individualPrinting
     */
    public adminIndividualUserPrinting() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminIndividualUserPrinting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminIndividualUserPrinting().setVisible(true);
            }
        });
    }
