 ...
 */
public class adminViewRent extends javax.swing.JFrame {

    /**
     * Creates new form adminDash
     */
    public adminViewRent() {
        initComponents();
        displayData();
        dt();
        times();
    ...
    private void initComponents() {
        ...
        acc_id.setText("ID");
        jPanel2.add(acc_id);
        acc_id.setBounds(620, 60, 90, 30);

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Current user:");
        jPanel2.add(jLabel4);
        jLabel4.setBounds(620, 20, 90, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminViewRent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminViewRent().setVisible(true);
            }
        });
    }
